...
class Gr00tN1d6Config(PretrainedConfig):
    ...
    use_backbone_lora: int = 0  # LoRA rank for vision backbone; 0 disables LoRA
    use_llm_lora: int = 0  # LoRA rank for language model; 0 disables LoRA
    ...
    use_action_head_diffusion_lora: int = 0
    tune_vlln: bool = True
