...
class TrainingConfig:
    ...
    online_eval_env_id: str | None = None
    ...
    """Run online evaluation every N epochs when using epoch-based training."""

    online_eval_num_episodes: int = 10
    """Number of episodes to evaluate per online evaluation run."""
    ...
    """Maximum episode length for online evaluation environments."""

    online_eval_sim_backend: str = "physx_cpu"
    """Simulation backend for online evaluation environments."""

    online_eval_control_mode: str = "pd_joint_pos"
    """Control mode for online evaluation environments."""

    online_eval_obs_mode: str = "rgb"
    """Observation mode for online evaluation environments."""

    online_eval_reward_mode: str = "sparse"
    """Reward mode for online evaluation environments."""

    online_eval_shader: str = "rt-fast"
    """Shader pack for online evaluation rendering."""

    online_eval_capture_video: bool = False
    """Record videos during online evaluation."""
