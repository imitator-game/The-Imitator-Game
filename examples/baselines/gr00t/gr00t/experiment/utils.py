...
class EpochBoundarySaveCallback(TrainerCallback):
    """Trigger checkpoint saves at explicit optimizer-step boundaries."""

    def __init__(self, save_step_points: list[int]):
        self.save_step_points = set(save_step_points)

    def on_step_end(self, args, state, control, **kwargs):
        if state.global_step in self.save_step_points:
