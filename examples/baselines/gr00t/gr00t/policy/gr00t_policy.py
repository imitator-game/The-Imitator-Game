    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            model: Optional in-memory model to use instead of loading from model_path
            processor: Optional in-memory processor to use instead of loading from model_path
        ...
        if model is None or processor is None:
            if model_path is None:
                raise ValueError("Either model_path or both model and processor must be provided")
