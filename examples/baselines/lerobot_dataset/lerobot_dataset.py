...
from examples.baselines.lerobot_dataset.video_utils import (
    ...
    def __init__(
        ...
        Args:
            ...
            vcodec (str, optional): Video codec for encoding videos during recording. Options: 'h264', 'hevc',
                'libx265', 'auto', or hardware-specific codecs like 'h264_videotoolbox', 'h264_nvenc'.
                Defaults to 'libx265'. Use 'auto' to auto-detect the best available hardware encoder.
            ...
            encoder_threads (int | None, optional): Number of threads per encoder instance. None lets the
                ...
                libx265 and 'threads' for h264/hevc.
        """
        super().__init__()
        self.repo_id = repo_id
