...
from examples.baselines.openvla_oft.prismatic.extern.hf.configuration_prismatic import PrismaticConfig
from examples.baselines.openvla_oft.prismatic.extern.hf.modeling_prismatic import PrismaticForConditionalGeneration
