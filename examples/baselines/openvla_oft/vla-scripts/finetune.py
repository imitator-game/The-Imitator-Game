...
from examples.baselines.openvla_oft.experiments.robot.openvla_utils import (
...
from examples.baselines.openvla_oft.prismatic.extern.hf.processing_prismatic import PrismaticImageProcessor, PrismaticProcessor
from examples.baselines.openvla_oft.prismatic.models.action_heads import DiffusionActionHead, L1RegressionActionHead
...
from examples.baselines.openvla_oft.prismatic.models.projectors import (
...
from examples.baselines.openvla_oft.prismatic.util.data_utils import PaddedCollatorForActionPrediction
...
from examples.baselines.openvla_oft.prismatic.vla.datasets import RLDSBatchTransform, RLDSDataset
from examples.baselines.openvla_oft.prismatic.vla.datasets.rlds.utils.data_utils import save_dataset_statistics
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    #
    # ---
    # from examples.baselines.openvla_oft.prismatic.vla.datasets import DummyDataset
    #
