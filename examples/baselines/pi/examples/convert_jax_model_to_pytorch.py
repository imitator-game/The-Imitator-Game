...
import examples.baselines.pi.src.openpi.models.gemma
import examples.baselines.pi.src.openpi.models.model
import examples.baselines.pi.src.openpi.models.pi0_config
import examples.baselines.pi.src.openpi.models_pytorch.pi0_pytorch
from examples.baselines.pi.src.openpi.training import utils
...
def slice_initial_orbax_checkpoint(checkpoint_dir: str, restore_precision: str | None = None):
    ...
    params = examples.baselines.pi.src.openpi.models.model.restore_params(
...
def convert_pi0_checkpoint(
    checkpoint_dir: str, precision: str, output_path: str, model_config: examples.baselines.pi.src.openpi.models.pi0_config.Pi0Config
):
    """
    ...
    action_expert_config = examples.baselines.pi.src.openpi.models.gemma.get_config("gemma_300m")
    ...
    # Instantiate model
    pi0_model = examples.baselines.pi.src.openpi.models_pytorch.pi0_pytorch.PI0Pytorch(model_config)
...
def main(
    ...
    *,
    ...
    if not isinstance(model_config, examples.baselines.pi.src.openpi.models.pi0_config.Pi0Config):
