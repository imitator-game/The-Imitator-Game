...
from examples.baselines.pi.src.openpi.models import model as _model
from examples.baselines.pi.src.openpi.models import pi0_config
import examples.baselines.pi.src.openpi.models.gemma as _gemma
import examples.baselines.pi.src.openpi.models.siglip as _siglip
from examples.baselines.pi.src.openpi.shared import array_typing as at
...
class Pi0(_model.BaseModel):
    def __init__(self, config: pi0_config.Pi0Config, rngs: nnx.Rngs):
        ...
        self.use_prefix_kv_cache = config.use_prefix_kv_cache
