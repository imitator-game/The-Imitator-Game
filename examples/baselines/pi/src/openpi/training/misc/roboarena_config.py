...
def get_roboarena_configs():
    ...
    from examples.baselines.pi.src.openpi.training.config import AssetsConfig
    from examples.baselines.pi.src.openpi.training.config import DataConfig
    from examples.baselines.pi.src.openpi.training.config import SimpleDataConfig
    from examples.baselines.pi.src.openpi.training.config import TrainConfig
