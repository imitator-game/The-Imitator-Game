...
def _set_l_level_in_subprocess(
    level: Optional[str],
    ...
    L0_L3_utils.set_lr_mirror_mode(None)
...
def make_eval_envs(
    ...
    if sim_backend == "physx_cpu":
        ...
        def cpu_make_env(
            ...
            def thunk():
                # Set/clear eval flags inside the subprocess to fix forkserver leakage.
                _set_l_level_in_subprocess(
                    l_level,
                ...
                if video_dir:
                    env = RecordEpisode(
                        ...
                        info_on_video=True,
                        source_type="rdt",
                        source_desc="rdt evaluation rollout",
                    )
        ...
        # For GPU backend, also set/clear eval flags before gym.make.
        _set_l_level_in_subprocess(
            l_level,
            lr_mirror_enabled=lr_mirror_enabled,
            lr_mirror_robot_pose_enabled=lr_mirror_robot_pose_enabled,
