...
@register_env("TwoRobotPlaceFruitBox-v1", max_episode_steps=100)
class TwoRobotPlaceFruitBoxEnv(BaseEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        (
            ...
            "035_apple",
            model_id=1,
            base_scale=(0.9, 0.9, 0.9),
            base_replace_scale=False,
            override_name="103_fruit",
            override_id=0,
            override_scale=(0.45, 0.45, 0.45),
        ...
        (
            ...
            self.pear_model_id,
            self.pear_scale,
            self.pear_replace_scale,
        ) = apply_l2_robotwin_config(
            "103_fruit",
            model_id=1,
            base_scale=(0.6, 0.6, 0.6),
            base_replace_scale=False,
            override_name="103_fruit",
            override_id=3,
            override_scale=(0.035, 0.035, 0.035),
        ...
        (
            ...
            "042_wooden_box",
            model_id=0,
            base_scale=(0.12, 0.14, 0.15),
            base_replace_scale=True,
            override_name="008_tray",
            override_id=0,
            override_scale=(0.12, 0.14, 0.15),
            override_replace_scale=True,
        )
    ...
    def _initialize_episode(self, env_idx: torch.Tensor, options: dict):
        with torch.device(self.device):
            ...
            xyz = apply_l1_offset_xy(xyz, offset=(-0.14, -0.05))
    ...
    def evaluate(self):
        ...
        apple_to_box = apple_pos - self.box.pose.p
        pear_to_box = pear_pos - self.box.pose.p
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: Dict):
        ...
        r_transport_apple = transport_reward(apple_pos, box_pos, is_apple_grasped, scale=5.0)
        ...
        r_transport_pear = transport_reward(pear_pos, box_pos, is_pear_grasped, scale=5.0)
