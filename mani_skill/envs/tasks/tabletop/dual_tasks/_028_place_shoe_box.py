...
@register_env("TwoRobotPlaceShoeBox-v1", max_episode_steps=100)
class TwoRobotPlaceShoeBoxEnv(BaseEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        (
            ...
            "007_shoe-box",
            model_id=0,
            base_scale=(0.6, 0.4, 0.4),
            base_replace_scale=True,
            override_name="042_wooden_box",
            override_id=0,
            override_scale=(0.14, 0.13, 0.16),
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: Dict):
        ...
        r_place_shoe_1 = torch.where(is_shoe_1_grasped, ones, r_place_shoe_1)
        ...
        r_place_shoe_2 = torch.where(is_shoe_2_grasped, ones, r_place_shoe_2)
