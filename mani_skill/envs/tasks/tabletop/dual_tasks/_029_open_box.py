...
@register_env("TwoRobotOpenBox-v1", max_episode_steps=100)
class TwoRobotOpenBoxEnv(BaseEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.box_model_ids = ["100189"]
        self.init_joint_qpos = -0.3
    ...
    def _load_box(self, origin_base, joint_types, model_ids, link_ids):
        for i, model_id in enumerate(model_ids):
            ...
            # Color the box for L2
            if is_l2_enabled():
                box_color = [0.5, 0.5, 0.5, 1.0]  # Gray
                for link in box.links:
                        ...
                        if rb_comp:
                            for render_shape in rb_comp.render_shapes:
                                for part in render_shape.parts:
                                    part.material.set_base_color(np.array(box_color))
            ...
            if is_l3_enabled():
                ...
                init_joint_qpos = self.init_joint_qpos
    ...
    def evaluate(self):
        ...
        # Note: is_grasping(Articulation) not supported, set to False
