...
@register_env("TwoRobotPourLiquidCup-v1", max_episode_steps=100)
class TwoRobotPourLiquidCupEnv(BaseEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        liquid_scale = (0.06, 0.06, 0.06)
        if is_l2_enabled():
            liquid_scale = (0.08, 0.08, 0.08)
    ...
    def compute_dense_reward(self, obs: Any, action: torch.Tensor, info: Dict):
        ...
        liquid_height_above_cup = info["liquid_height_above_cup"]
        liquid_ever_poured = info["liquid_ever_poured"]
        ...
        # Reward based on how close the bottle is to being above the cup
        # We reward both being above AND close horizontally
