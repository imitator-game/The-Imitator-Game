...
@register_env("TwoRobotPourLiquidFilterL3-v1", max_episode_steps=100)
class TwoRobotPourLiquidFilterEnvL3(BaseEnv):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.liquid_scale = (0.8, 0.8, 0.8)
        self.cup_scale = (1, 1, 1)
    ...
    def _load_scene(self, options: dict):
        ...
        # Load kettle as the pouring object while keeping the liquid task interface.
        ...
        liquid_actor_obj = create_actor(
            ...
            scale=self.liquid_scale,
            replace_scale=False,
        )
        liquid_actor_obj.set_mass(0.1)
    ...
    def _initialize_episode(self, env_idx: torch.Tensor, options: dict):
        with torch.device(self.device):
            ...
            # Match kettle initialization from _020_pour_kettle: default yaw pi, mirrored yaw 0.
            liquid_z_rot = np.pi
    ...
    def evaluate(self):
        ...
        currently_pouring = is_grasped & is_lifted & is_above_cup & is_tilted
    ...
    def _get_pour_target_pos(self) -> torch.Tensor:
        ...
        offset_x = 0.13 if is_lr_mirror_enabled() else -0.13
        offset = torch.tensor(
            [offset_x, 0.0, 0.0],
            device=self.device,
