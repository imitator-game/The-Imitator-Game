...
from mani_skill.envs.tasks import TwoRobotPickFruitsToPlateEnv
...
def _pick_and_place(
    env: TwoRobotPickFruitsToPlateEnv,
...
def solve(env: TwoRobotPickFruitsToPlateEnv, seed=None, debug: bool = False, vis: bool = False):
    env.reset(seed=seed)
