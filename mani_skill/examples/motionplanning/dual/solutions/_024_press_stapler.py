...
from mani_skill.envs.tasks import TwoRobotPressStaplerEnv
from mani_skill.examples.motionplanning.panda.motionplanner import \
    PandaArmMotionPlanningSolver
from mani_skill.examples.motionplanning.panda.utils import (
    compute_grasp_info_by_obb, get_actor_obb)

def solve(env: TwoRobotPressStaplerEnv, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    ...
    grasp_pose = env.stapler.pose * sapien.Pose(p=(0, 0.1, 0.05), q=euler2quat(np.pi / 2, np.pi / 2, 0))
