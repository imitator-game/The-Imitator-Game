...
def solve(env: TwoRobotPlaceFoodScaleEnv, seed=None, debug=False, vis=False):
    ...
    reach_pose2 = grasp_pose * mirror_offset_pose(sapien.Pose([0.05, 0, -0.2]))
    reach_pose1 = grasp_pose * mirror_offset_pose(sapien.Pose([0.05, 0, -0.15]))
    left_planner.move_to_pose_with_screw(reach_pose1, other_gripper_state=right_planner.gripper_state)
    left_planner.move_to_pose_with_screw(grasp_pose * mirror_offset_pose(sapien.Pose([0.05, 0, -0.05])), other_gripper_state=right_planner.gripper_state)
    ...
    reach_pose3 = goal_pose * mirror_offset_pose(sapien.Pose([0.05, 0.05, -0.2]))
    left_planner.move_to_pose_with_screw(reach_pose3, other_gripper_state=right_planner.gripper_state)
    left_planner.move_to_pose_with_screw(goal_pose * mirror_offset_pose(sapien.Pose([0.05, 0.05, -0.05])), other_gripper_state=right_planner.gripper_state)
    ...
    goal_pose = sapien.Pose(env.box.pose.sp.p, grasp_pose.q) * sapien.Pose([0, 0, -0.05])
    reach_pose2 = grasp_pose * mirror_offset_pose(sapien.Pose([-0.05, -0.0, -0.2]))
    reach_pose1 = grasp_pose * mirror_offset_pose(sapien.Pose([-0.05, -0.0, -0.15]))
    right_planner.move_to_pose_with_screw(reach_pose1, other_gripper_state=left_planner.gripper_state)
    right_planner.move_to_pose_with_screw(grasp_pose * mirror_offset_pose(sapien.Pose([-0.05, -0.0, -0.05])), other_gripper_state=left_planner.gripper_state)
    ...
    right_planner.move_to_pose_with_screw(goal_pose * mirror_offset_pose(sapien.Pose([-0.05, -0.05, -0.05])), other_gripper_state=left_planner.gripper_state)
