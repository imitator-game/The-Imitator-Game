...
from mani_skill.envs.tasks import TwoRobotPlaceChipsRackEnvL3
from mani_skill.examples.motionplanning.panda.motionplanner import \
    PandaArmMotionPlanningSolver


def solve(env: TwoRobotPlaceChipsRackEnvL3, seed=None, debug=False, vis=False):
    """
    ...
    # -------------------------------------------------------------------------- #
    prep_pose = grasp_pose * sapien.Pose([0, 0, -0.2])
    ...
    reach_pose1 = grasp_pose * sapien.Pose([0, 0, -0.16])
    left_planner.move_to_pose_with_screw(
        reach_pose1,
        other_gripper_state=right_planner.gripper_state
    )
    ...
    reach_pose2 = goal_pose * sapien.Pose([0, 0.1, -0.3])
    left_planner.move_to_pose_with_screw(
        reach_pose2,
        other_gripper_state=right_planner.gripper_state
    )
    ...
    # -------------------------------------------------------------------------- #
    left_planner.move_to_pose_with_screw(
        goal_pose * sapien.Pose([0.05, 0.1, -0.22]),
        other_gripper_state=right_planner.gripper_state
    )
    ...
    # -------------------------------------------------------------------------- #
    retract_pose = goal_pose * sapien.Pose([0, 0.1, -0.4])
    left_planner.move_to_pose_with_screw(
        retract_pose,
        other_gripper_state=right_planner.gripper_state
    )
    ...
    # avoid touching chip
    retract_pose = goal_pose * sapien.Pose([0, 0.3, -0.3])
    left_planner.move_to_pose_with_screw(
        retract_pose,
        other_gripper_state=right_planner.gripper_state
    )
