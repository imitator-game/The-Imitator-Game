...
from mani_skill.envs.tasks import TwoRobotPourKettleEnvL3
from mani_skill.envs.tasks.tabletop.utils.L0_L3_utils import mirror_sign
from mani_skill.examples.motionplanning.panda.motionplanner import \
    PandaArmMotionPlanningSolver


def solve(env: TwoRobotPourKettleEnvL3, seed=None, debug=False, vis=False):
    """
    Phases:
    1. Grasp kettle
    2. Lift kettle
    ...
    ) * sapien.Pose(q=euler2quat(0.0, np.pi / 4, 0.0))
