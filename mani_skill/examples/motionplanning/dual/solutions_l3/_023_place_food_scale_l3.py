...
from mani_skill.envs.tasks import TwoRobotPlaceFoodScaleEnvL3
...
def _pick_and_place(
    env: TwoRobotPlaceFoodScaleEnvL3,
...
def solve(env: TwoRobotPlaceFoodScaleEnvL3, seed=None, debug: bool = False, vis: bool = False):
    env.reset(seed=seed)
    ...
    _pick_and_place(env, left_planner, right_planner, agent_id=0, obj=env.vegetable, place_center_xyz=scale_center_xyz, vis=vis, plate_on_scale_offset_y=-PLATE_ON_SCALE_OFFSET_Y, plate_on_scale_offset_z=PLATE_ON_SCALE_OFFSET_Z)
