...
def solve(env: TwoRobotPlaceCupPlateEnv, seed=None, debug=False, vis=False):
    ...
    goal_pose = sapien.Pose(region_a_center, grasp_pose.q) * sapien.Pose([0, 0, -0.05])
    ...
    left_planner.move_to_pose_with_screw(grasp_pose * sapien.Pose([0.0, 0, -0.08]), other_gripper_state=right_planner.gripper_state)
    ...
    reach_pose3 = goal_pose * sapien.Pose([0.0, 0.0, -0.2])
    left_planner.move_to_pose_with_screw(reach_pose3, other_gripper_state=right_planner.gripper_state)
    left_planner.move_to_pose_with_screw(goal_pose * sapien.Pose([0.0, 0.0, -0.1]), other_gripper_state=right_planner.gripper_state)
    left_planner.open_gripper(other_gripper_state=right_planner.gripper_state)
    left_planner.move_to_pose_with_screw(reach_pose3 * sapien.Pose([0.0, 0.0, -0.08]), other_gripper_state=right_planner.gripper_state)
    ...
    goal_pose = sapien.Pose(region_b_center, grasp_pose.q) * sapien.Pose([0, 0, -0.05])
    reach_pose2 = grasp_pose * sapien.Pose([-0.0, -0.0, -0.2])
    reach_pose1 = grasp_pose * sapien.Pose([-0.0, -0.0, -0.15])
    right_planner.move_to_pose_with_screw(reach_pose1, other_gripper_state=left_planner.gripper_state)
    right_planner.move_to_pose_with_screw(grasp_pose * sapien.Pose([-0.0, -0.0, -0.04]), other_gripper_state=left_planner.gripper_state)
    ...
    right_planner.move_to_pose_with_screw(goal_pose * sapien.Pose([0.0, 0.0, -0.05]), other_gripper_state=left_planner.gripper_state)
    right_planner.open_gripper(other_gripper_state=left_planner.gripper_state)
    right_planner.move_to_pose_with_screw(reach_pose3 * sapien.Pose([0.0, 0.0, -0.06]), other_gripper_state=left_planner.gripper_state)
