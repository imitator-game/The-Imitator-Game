...
from mani_skill.examples.motionplanning.ur10e_shadow.solutions import solveTest
MP_SOLUTIONS = {
    "PickCube-shadow-v1": solveTest,
}
def parse_args(args=None):
    parser = argparse.ArgumentParser()
    parser.add_argument("-e", "--env-id", type=str, default="PickCube-shadow-v1", help=f"Environment to run motion planning solver on. Available options are {list(MP_SOLUTIONS.keys())}")
    ...
    parser.add_argument("--reward-mode", default="dense", type=str)
