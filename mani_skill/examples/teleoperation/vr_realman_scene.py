...
class VRRealmanROSController:
    ...
    def get_joint_control_action(self):
        ...
        action[16] = self.target_gripper_status[0]  # left gripper
        action[17] = self.target_gripper_status[1]  # right gripper
        # action = np.array([
        #         # head fixed to 0
        ...
        qpos_reconstructed[16] = self.target_gripper_status[0]  # left gripper
        qpos_reconstructed[17] = self.target_gripper_status[1]  # right gripper
